   ...
   <div id="templatemo_main">
     ...
     <table>
        ...
        <tr>
            ...
            <td> <label>  <?php echo $value['code']; ?></label></td>
            <td> <label >  <?php echo $value['price']; ?></label> </td>
            <td>     <a href= <?php echo "/admin/product/edit/" . $value['id']; ?> > <button><?php echo $translate['edit']; ?></button>
        </a>
</td>
            <td>  <a href=<?php echo "/admin/product/delete/" . $value['id']; ?>>     <button><?php echo $translate['delete']; ?></button></a>
     ...
     <?php endforeach;?>
                      ...
                      <!--    <?php foreach ($products as $key => $value): ?>
                          ...
                          <label>  <?php echo $value->get_cat_id(); ?></label>
                          <label >  <?php echo $value->get_price(); ?></label>
                        <div class="cleaner h10"></div>
                         <?php endforeach;?> -->
