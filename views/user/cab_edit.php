            ...
            <div class="content_half float_l">
                ...
                <div id="contact_form">
                   <form method="post" name="contact" action="/user/edit">
                        ...
                        <label for="name"><?php echo $translate['input_new_name'].':'; ?></label> <input value=<?php echo User::get_User_By_Id()['name'] ?> type="text" id="name" name="name" class="validate-email required input_field" />
                        <div class="cleaner h10"></div>
                        
            <label for="subject"><?php echo $translate['input_new_pass'].':'; ?></label> <input value="111111" type="text" name="pass" id="pass" class="input_field" />
